          ...
          <div>
            ...
            <div className="relative group">
              <input
                ...
                className="w-full bg-[#161616] border border-white/10 rounded-full px-6 py-3 text-sm focus:outline-none focus:border-[#00E5FF]"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 w-10 h-10 bg-[#00E5FF] rounded-full flex items-center justify-center text-black">
